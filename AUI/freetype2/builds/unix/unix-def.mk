...
LIBSSTATIC_CONFIG          := -lfreetype -lz -lbz2 -lpng16 -lm -lz -lharfbuzz -pthread -lm -lfreetype -lbz2 -lpng16 -lm -lz -lbrotlidec -lbrotlicommon -lglib-2.0 -latomic -lm -lsysprof-capture-4 -Wl,-z,nodelete -pthread -lpcre2-8 -lgraphite2 -lbrotlidec -lbrotlicommon
build_libtool_libs         := 
ft_version                 := 26.6.20
