...
// ------------------------------------------------------------------
      ...
      void SetMinWidth(int32_t w) {mMinWidth = w;}
      int32_t GetMinWidth() const {return mMinWidth;}
      void SetPadding(int32_t pad) {mPadding = pad;}
      int32_t GetPadding() const {return mPadding;}
      void SetSubmenuDelayMs(int32_t ms) {mSubmenuDelayMs = ms;}
      int32_t GetSubmenuDelayMs() const {return mSubmenuDelayMs;}
...
// Submenu hierarchy
// ------------------------------------------------------------------
      void SetParentMenu(AMenu *parent) {mParentMenu = parent;}
      AMenu* GetParentMenu() const {return mParentMenu;}
...
// Accessors
// ------------------------------------------------------------------
      int32_t GetHoveredIndex() const {return mHoveredIndex;}
